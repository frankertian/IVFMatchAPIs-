...
namespace IVFMatchAPIs.Helpers.FaceCompareUtil
{
    public class ImageUtil
    {
        ...
        public static void ResizeImage(int newWidth, int newHeight)
        {
            string foldPath = System.Environment.CurrentDirectory;
            string imagePath = Path.Combine(foldPath, "photo.bmp");
            string outPath = Path.Combine(foldPath, "out.bmp");
            using (Bitmap bitmap = (Bitmap)Image.FromFile(imagePath))
            {
                ...
                newBitMap.Save(outPath, ImageFormat.Bmp);
            }
        }

        public static Bitmap ResizeImage(int newWidth, int newHeight, string imagePath)
        {
            string foldPath = System.Environment.CurrentDirectory;
            using (Bitmap bitmap = (Bitmap)Image.FromFile(imagePath))
            {
